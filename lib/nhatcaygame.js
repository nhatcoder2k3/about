...
window.location.hash = "", $(window).on("load", function () {
...
}), fixedMenu = "undefined" == typeof fixedMenu || fixedMenu, viewAllText = "undefined" != typeof viewAllText ? viewAllText : exportify.viewAll, $("#vuminhnhat-pro-main-nav").menuify(), $("#vuminhnhat-pro-main-nav .widget").addClass("show-menu"), $(".show-search").on("click", function () {
...
}), $("#vuminhnhat-pro-new-before-ad").each(function () {
    var e = $(this);
    e.length && $("#before-ad").appendTo(e)
}), $("#vuminhnhat-pro-new-after-ad").each(function () {
    var e = $(this);
    e.length && $("#after-ad").appendTo(e)
}), $("#vuminhnhat-pro-main-before-ad .widget").each(function () {
    var e = $(this);
    e.length && e.appendTo($("#before-ad"))
}), $("#vuminhnhat-pro-main-after-ad .widget").each(function () {
    var e = $(this);
    e.length && e.appendTo($("#after-ad"))
}), $("#vuminhnhat-pro-post-footer-ads .widget").each(function () {
    var e = $(this);
...
}), $(".vuminhnhat-pro-share-links").each(function () {
    var e = $(this);
...
}), $("#vuminhnhat-pro-main-nav-menu li.mega-menu").each(function (e, t) {
    var a = $(this),
...
}), $(".vuminhnhat-pro-widget-ready .HTML .widget-content").each(function (e, t, a, o) {
    var r = $(this),
        i = $(window),
        s = r.data("shortcode");
...
}), $("#vuminhnhat-pro-related-posts .HTML").each(function (e, t) {
    var a = [];
    $(".vuminhnhat-pro-related-content meta").each(function () {
    ...
    if (null != o) {
        ...
        $("#related-wrap").each(function (e, t) {
            var o = $(this),
                i = $(window),
                s = o.find(".vuminhnhat-pro-related-content"),
                n = r();
...
}), $(".vuminhnhat-pro-blog-post-comments").each(function () {
    var e = $(this),
        t = e.data("shortcode"),
    ...
    $(".entry-image-wrap .entry-thumb,.author-avatar-wrap .author-avatar,#particle, .ratio-16-10").lazyify(), $("#vuminhnhat-pro-mobile-menu").each(function () {
        var e = $(this),
            t = $("#vuminhnhat-pro-main-nav-menu").clone();
        t.attr("id", "main-mobile-nav"), t.find(".mega-items").remove(), t.find(".mega-menu > a").each(function (e, t) {
            var a = $(this),
                o = a.data("shortcode");
            null != o && (t = "recent" == (e = shortCodeIfy(o.trim(), "label")) ? "/search" : "/search/label/" + e, a.attr("href", t))
        }), t.appendTo(e), $(".mobile-menu-toggle, .hide-vuminhnhat-pro-mobile-menu, .overlay").on("click", function () {
            $("body").toggleClass("nav-active")
        }), $(".vuminhnhat-pro-mobile-menu .has-sub").append('<div class="submenu-toggle"/>'), $(".vuminhnhat-pro-mobile-menu .mega-menu").find(".submenu-toggle").remove(), $(".vuminhnhat-pro-mobile-menu ul li .submenu-toggle").on("click", function (e) {
            $(this).parent().hasClass("has-sub") && (e.preventDefault(), $(this).parent().hasClass("show") ? $(this).parent().removeClass("show").find("> .m-sub").slideToggle(170) : $(this).parent().addClass("show").children(".m-sub").slideToggle(170))
        })
    }), $(".mm-footer .mm-social").each(function () {
        var e = $(this),
            t = $("#vuminhnhat-pro-about-section ul.social").clone();
    ...
    }), $("#vuminhnhat-pro-load-more-link").each(function () {
        var e = $(this).data("load");
        e && $("#vuminhnhat-pro-load-more-link").show(), $("#vuminhnhat-pro-load-more-link").on("click", function (t) {
            $("#vuminhnhat-pro-load-more-link").hide(), $.ajax({
                url: e,
                success: function (t) {
                    var a = $(t).find(".blog-posts");
                    a.find(".index-post").addClass("post-animated post-fadeInUp"), $(".blog-posts").append(a.html()), (e = $(t).find("#vuminhnhat-pro-load-more-link").data("load")) ? $("#vuminhnhat-pro-load-more-link").show() : ($("#vuminhnhat-pro-load-more-link").hide(), $("#blog-pager .no-more").addClass("show"))
                },
                beforeSend: function () {
    ...
    }), $("#vuminhnhat-pro-cookie-ify").each(function () {
        var e = $(this),
            t = e.find(".widget.Text").data("shortcode");
        null != t && (ok = shortCodeIfy(t, "ok"), days = shortCodeIfy(t, "days"), 0 != ok && e.find("#vuminhnhat-pro-cookie-ify-accept").text(ok), 0 != days ? days = Number(days) : days = 7), e.length > 0 && ("1" !== $.cookie("vuminhnhat_pro_cookie_ify_consent") && (e.css("display", "block"), $(window).on("load", function () {
            e.addClass("is-visible")
        })), $("#vuminhnhat-pro-cookie-ify-accept").off("click").on("click", function (t) {
            t.preventDefault(), t.stopPropagation(), $.cookie("vuminhnhat_pro_cookie_ify_consent", "1", {
                expires: days,
                path: "/"
        ...
        $(window).on("scroll", function () {
            var t = window.innerHeight,
                a = $("#vuminhnhat-pro-cta2-section ul.cta-containter");
